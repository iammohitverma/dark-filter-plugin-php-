...
!(function (a) {
  ...
  function e(b, c) {
    ...
    function f(a, b, c) {
      ...
      return 0 === f.length
        ? Promise.resolve(b)
        : d(b, n.asArray(f), c).then(function () {
            return b;
          });
    }
    function g(b, c) {
  ...
  function m() {
    function a(a) {
      function b(b) {
        return n.isDataUrl(a.src)
          ? Promise.resolve()
          : Promise.resolve(a.src)
              .then(b || n.getAndEncode)
              .then(function (b) {
      ...
      return c instanceof Element
        ? d(c).then(function () {
            return c instanceof HTMLImageElement
              ? a(c).inline()
              : Promise.all(
                  n.asArray(c.childNodes).map(function (a) {
                    return b(a);
                  })
                );
          })
  ...
  a.domtoimage = {
    ...
    toPng: c,
    toBlob: d,
    impl: { fontFaces: p, images: q, util: n, inliner: o },
  };
})(this);
